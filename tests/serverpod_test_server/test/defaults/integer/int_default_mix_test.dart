  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () {
          final object = IntDefaultMix(intDefaultAndDefaultModel: 15);
      ...
      test(
        ...
        () {
          final object = IntDefaultMix(intDefaultAndDefaultPersist: 25);
      ...
      test(
        ...
        () {
          final object = IntDefaultMix(intDefaultModelAndDefaultPersist: 30);
