  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () {
          final object = DoubleDefaultMix(doubleDefaultAndDefaultModel: 15.5);
      ...
      test(
        ...
        () {
          final object = DoubleDefaultMix(doubleDefaultAndDefaultPersist: 25.5);
