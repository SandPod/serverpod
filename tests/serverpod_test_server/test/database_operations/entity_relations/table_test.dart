  ...
  group('Given models with deep nested relations', () {
    group('when building expression with deep nested relations', () {
      ...
      test('then each column expression has table relation.', () {
        ...
        expect(
          columnWithTableRelations.length,
          2,
          reason:
    ...
    group('when accessing nested relations fields', () {
      ...
      test(
        'then an table relation is build for each table relation reference.',
        () {
          expect(
            nestedRelationAccess.table.tableRelation?.getRelations.length,
            3,
            reason:
...
void expectTableRelationWith({
  ...
  expect(
    actualTableRelation.fieldNameWithJoins,
    expectedLastJoiningField,
    reason: 'Last joining field is wrong.',
  );
  expect(
    actualTableRelation.foreignFieldNameWithJoins,
    expectedLastJoiningForeignField,
