...
import 'serverOnly/server_only_class.dart' as _i24;
import 'serverOnly/server_only_enum.dart' as _i25;
import 'simple_data.dart' as _i26;
import 'simple_data_list.dart' as _i27;
import 'test_enum.dart' as _i28;
import 'town.dart' as _i29;
import 'types.dart' as _i30;
import 'protocol.dart' as _i31;
import 'dart:typed_data' as _i32;
import 'package:serverpod_test_server/src/generated/citizen.dart' as _i33;
...
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i37;
export 'citizen.dart';
export 'company.dart';
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i5.Citizen) {
      return _i5.Citizen.fromJson(data, this) as T;
    }
    if (t == _i6.Company) {
    ...
    if (t == _i24.ServerOnlyClass) {
      return _i24.ServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i25.ServerOnlyEnum) {
      return _i25.ServerOnlyEnum.fromJson(data) as T;
    }
    if (t == _i26.SimpleData) {
      return _i26.SimpleData.fromJson(data, this) as T;
    }
    if (t == _i27.SimpleDataList) {
      return _i27.SimpleDataList.fromJson(data, this) as T;
    }
    if (t == _i28.TestEnum) {
    ...
    if (t == _i1.getType<_i5.Citizen?>()) {
      return (data != null ? _i5.Citizen.fromJson(data, this) : null) as T;
    }
    ...
    if (t == _i1.getType<_i24.ServerOnlyClass?>()) {
      return (data != null ? _i24.ServerOnlyClass.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i25.ServerOnlyEnum?>()) {
      return (data != null ? _i25.ServerOnlyEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i26.SimpleData?>()) {
      return (data != null ? _i26.SimpleData.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i27.SimpleDataList?>()) {
      return (data != null ? _i27.SimpleDataList.fromJson(data, this) : null)
          as T;
    }
    ...
    if (t == List<_i33.Citizen>) {
      return (data as List).map((e) => deserialize<_i33.Citizen>(e)).toList()
          as dynamic;
    }
    if (t == List<int>) {
      return (data as List).map((e) => deserialize<int>(e)).toList() as dynamic;
    ...
    if (t == List<_i34.SimpleData>) {
      return (data as List).map((e) => deserialize<_i34.SimpleData>(e)).toList()
          as dynamic;
    }
    if (t == List<_i34.SimpleData?>) {
      return (data as List)
          .map((e) => deserialize<_i34.SimpleData?>(e))
          .toList() as dynamic;
    }
    if (t == _i1.getType<List<_i34.SimpleData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i34.SimpleData>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i34.SimpleData>?>()) {
      return (data != null
    ...
    if (t == Map<_i35.TestEnum, int>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
              deserialize<_i35.TestEnum>(e['k']), deserialize<int>(e['v']))))
          as dynamic;
    }
    if (t == Map<String, _i35.TestEnum>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i35.TestEnum>(v)))
          as dynamic;
    }
    ...
    if (t == Map<String, _i34.SimpleData>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i34.SimpleData>(v)))
          as dynamic;
    }
    if (t == Map<String, _i34.SimpleData?>) {
      return (data as Map).map((k, v) => MapEntry(
          deserialize<String>(k), deserialize<_i34.SimpleData?>(v))) as dynamic;
    }
    if (t == _i1.getType<Map<String, _i34.SimpleData>?>()) {
      return (data != null
          ? (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i34.SimpleData>(v)))
          : null) as dynamic;
    ...
    if (t == _i1.getType<Map<String, _i34.SimpleData?>?>()) {
      return (data != null
          ? (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<_i34.SimpleData?>(v)))
          : null) as dynamic;
    }
    if (t == _i1.getType<Map<String, _i34.SimpleData?>?>()) {
      return (data != null
    ...
    if (t == _i36.CustomClass) {
      return _i36.CustomClass.fromJson(data, this) as T;
    }
    if (t == _i37.ExternalCustomClass) {
      return _i37.ExternalCustomClass.fromJson(data, this) as T;
    }
    if (t == _i37.FreezedCustomClass) {
      return _i37.FreezedCustomClass.fromJson(data, this) as T;
    }
    if (t == _i1.getType<_i36.CustomClass?>()) {
      return (data != null ? _i36.CustomClass.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i37.ExternalCustomClass?>()) {
      return (data != null
          ? _i37.ExternalCustomClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i37.FreezedCustomClass?>()) {
      return (data != null
          ? _i37.FreezedCustomClass.fromJson(data, this)
          : null) as T;
    }
    try {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i36.CustomClass) {
      return 'CustomClass';
    }
    if (data is _i37.ExternalCustomClass) {
      return 'ExternalCustomClass';
    }
    if (data is _i37.FreezedCustomClass) {
      return 'FreezedCustomClass';
    }
    if (data is _i5.Citizen) {
      return 'Citizen';
    }
    ...
    if (data is _i24.ServerOnlyClass) {
      return 'ServerOnlyClass';
    }
    if (data is _i25.ServerOnlyEnum) {
      return 'ServerOnlyEnum';
    }
    if (data is _i26.SimpleData) {
      return 'SimpleData';
    }
    if (data is _i27.SimpleDataList) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'CustomClass') {
      return deserialize<_i36.CustomClass>(data['data']);
    }
    if (data['className'] == 'ExternalCustomClass') {
      return deserialize<_i37.ExternalCustomClass>(data['data']);
    }
    if (data['className'] == 'FreezedCustomClass') {
      return deserialize<_i37.FreezedCustomClass>(data['data']);
    }
    if (data['className'] == 'Citizen') {
      return deserialize<_i5.Citizen>(data['data']);
    }
    ...
    if (data['className'] == 'ServerOnlyClass') {
      return deserialize<_i24.ServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'ServerOnlyEnum') {
      return deserialize<_i25.ServerOnlyEnum>(data['data']);
    }
    if (data['className'] == 'SimpleData') {
      return deserialize<_i26.SimpleData>(data['data']);
    }
    if (data['className'] == 'SimpleDataList') {
      return deserialize<_i27.SimpleDataList>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      case _i5.Citizen:
        return _i5.Citizen.t;
      case _i6.Company:
        return _i6.Company.t;
      case _i10.ObjectFieldScopes:
        return _i10.ObjectFieldScopes.t;
      case _i11.ObjectWithByteData:
        return _i11.ObjectWithByteData.t;
      case _i12.ObjectWithDuration:
        return _i12.ObjectWithDuration.t;
      case _i13.ObjectWithEnum:
        return _i13.ObjectWithEnum.t;
      case _i14.ObjectWithIndex:
        return _i14.ObjectWithIndex.t;
      case _i16.ObjectWithObject:
        return _i16.ObjectWithObject.t;
      case _i17.ObjectWithParent:
        return _i17.ObjectWithParent.t;
      case _i18.ObjectWithSelfParent:
        return _i18.ObjectWithSelfParent.t;
      case _i19.ObjectWithUuid:
        return _i19.ObjectWithUuid.t;
      case _i26.SimpleData:
        return _i26.SimpleData.t;
      case _i29.Town:
        return _i29.Town.t;
      case _i30.Types:
        return _i30.Types.t;
