...
class CitizenTable extends _i1.Table {
  CitizenTable() : super(tableName: 'citizen');
  ...
  final companyId = _i1.ColumnInt('companyId');

  final oldCompanyId = _i1.ColumnInt('oldCompanyId');
  ...
  _i1.TableRelation? getRelation(String relationField) {
    if (relationField == 'company') {
      return _i1.TableRelation(
        referencedColumn: _i2.Company.t.id,
        referencingColumn: companyId,
      );
    }
    if (relationField == 'oldCompany') {
      return _i1.TableRelation(
        referencedColumn: _i2.Company.t.id,
        referencingColumn: oldCompanyId,
      );
    }
    return null;
  }
