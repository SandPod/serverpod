...
import '../endpoints/citizen_endpoint.dart' as _i5;
...
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i39;
import 'package:serverpod_test_module_server/module.dart' as _i40;
import 'package:serverpod_auth_server/module.dart' as _i41;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['citizen'] = _i1.EndpointConnector(
      name: 'citizen',
      endpoint: endpoints['citizen']!,
      methodConnectors: {
        'getAllShallow': _i1.MethodConnector(
          name: 'getAllShallow',
          params: {},
          call: (
            _i1.Session session,
            Map<String, dynamic> params,
              ...
              (endpoints['citizen'] as _i5.CitizenEndpoint)
                  .getAllShallow(session),
        ),
        'getAllWithDeepIncludes': _i1.MethodConnector(
          name: 'getAllWithDeepIncludes',
          params: {},
          call: (
            _i1.Session session,
            Map<String, dynamic> params,
        ...
        'storeTypes': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['basicDatabase'] as _i9.BasicDatabase).storeTypes(
            session,
            params['types'],
          ),
        ),
      ...
      methodConnectors: {
        'storeObject': _i1.MethodConnector(
          ...
          params: {
            'object': _i1.ParameterDescription(
              name: 'object',
              type: _i1.getType<_i37.ObjectFieldScopes>(),
              nullable: false,
            )
          },
          call: (
      ...
      methodConnectors: {
        ...
        'returnEnumIntMap': _i1.MethodConnector(
          ...
          params: {
            'map': _i1.ParameterDescription(
              name: 'map',
              type: _i1.getType<Map<_i39.TestEnum, int>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnEnumMap': _i1.MethodConnector(
          ...
          params: {
            'map': _i1.ParameterDescription(
              name: 'map',
              type: _i1.getType<Map<String, _i39.TestEnum>>(),
              nullable: false,
            )
          },
          call: (
      ...
      methodConnectors: {
        ...
        'modifyModuleObject': _i1.MethodConnector(
          ...
          params: {
            'object': _i1.ParameterDescription(
              name: 'object',
              type: _i1.getType<_i40.ModuleClass>(),
              nullable: false,
            )
          },
          call: (
    ...
    modules['serverpod_test_module'] = _i40.Endpoints()
