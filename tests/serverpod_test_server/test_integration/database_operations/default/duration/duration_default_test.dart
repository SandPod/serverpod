  ...
  group('Given a class with "default" Duration fields,', () {
    ...
    test(
      ...
      () async {
        ...
        final databaseObject = await DurationDefault.db.insertRow(
          session,
          object,
        );
        expect(
    ...
    test(
      ...
      () async {
        ...
        final specificObject = DurationDefault(
          durationDefault: specificDuration,
        );
        final specificDatabaseObject = await DurationDefault.db.insertRow(
          session,
          specificObject,
        );
        expect(
