  ...
  group('Given a class with mixed default fields,', () {
    ...
    test(
      ...
      () async {
        ...
        final databaseObject = await DoubleDefaultMix.db.findFirstRow(session);
    ...
    test(
      ...
      () async {
        final specificObject = DoubleDefaultMix(
          doubleDefaultAndDefaultModel: 30.5,
        );
        final specificDatabaseObject = await DoubleDefaultMix.db.insertRow(
          session,
          specificObject,
        );
