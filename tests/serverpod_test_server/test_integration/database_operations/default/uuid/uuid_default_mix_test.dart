  ...
  group('Given a class with mixed default UUID fields,', () {
    ...
    test(
      ...
      () async {
        ...
        final databaseObject = await UuidDefaultMix.db.findFirstRow(session);
        expect(
    ...
    test(
      ...
      () async {
        ...
        final specificObject = UuidDefaultMix(
          uuidDefaultAndDefaultModel: uuid,
        );
        final specificDatabaseObject = await UuidDefaultMix.db.insertRow(
          session,
          specificObject,
        );
        expect(
