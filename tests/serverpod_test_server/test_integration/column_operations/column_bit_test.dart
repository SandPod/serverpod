  ...
  group('Given bit column in database', () {
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          orderBy: (final t) => t.aBit.distanceHamming(queryBit),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aBit.distanceHamming(queryBit) < 3.0,
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          orderBy: (final t) => t.aBit.distanceJaccard(queryBit),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aBit.distanceJaccard(queryBit) < 1.0,
        );
    ...
    test(
      ...
      () async {
        ...
        final result = await Types.db.find(
          session,
          where: (final t) => t.aBit.distanceHamming(thirdBit) < 1.0,
        );
