  ...
  group('Given enum column in database', () {
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.anEnum.equals(TestEnum.one),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.anEnum.equals(null),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.anEnum.notEquals(TestEnum.one),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.anEnum.notEquals(null),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.anEnum.notInSet({
            TestEnum.one,
          }),
        );
