  ...
  group('Given sparse vector column in database', () {
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          orderBy: (final t) => t.aSparseVector.distanceL2(querySparseVector),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aSparseVector.distanceL2(querySparseVector) < 1.0,
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          orderBy: (final t) => t.aSparseVector.distanceCosine(querySparseVector),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aSparseVector.distanceCosine(querySparseVector) < 0.5,
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          orderBy: (final t) => t.aSparseVector.distanceL1(querySparseVector),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aSparseVector.distanceL1(querySparseVector) < 2.0,
        );
