...
void main() async {
  ...
  group('Given count column in database', () {
    test('when filtering on equals then matching row is returned.', () async {
      ...
      final result = await Customer.db.find(
        session,
        where: (final c) => c.orders.count().equals(2),
      );
    ...
    test(
      ...
      () async {
        ...
        final result = await Customer.db.find(
          session,
          where: (final c) => c.orders.count().equals(0),
        );
    ...
    test(
      ...
      () async {
        ...
        final result = await Customer.db.find(
          session,
          where: (final c) => c.orders.count().notEquals(1),
        );

        expect(result, hasLength(2));
        final resultNames = result.map((final e) => e.name);
    ...
    test(
      ...
      () async {
        ...
        final result = await Customer.db.find(
          session,
          where: (final c) => c.orders.count().notEquals(0),
        );
    ...
    test('when filtering on inSet then matching row is returned.', () async {
      ...
      final result = await Customer.db.find(
        session,
        where: (final c) => c.orders.count().inSet({0, 2}),
      );
    ...
    test('when filtering with an empty inSet then no rows are.', () async {
      ...
      final result = await Customer.db.find(
        session,
        where: (final c) => c.orders.count().inSet({}),
      );
    ...
    test('when filtering on notInSet then matching row is returned.', () async {
      ...
      final result = await Customer.db.find(
        session,
        where: (final c) => c.orders.count().notInSet({1}),
      );
    ...
    test(
      ...
      () async {
        ...
        final result = await Customer.db.find(
          session,
          where: (final c) => c.orders.count().notInSet({}),
        );

        expect(result, hasLength(3));
        final resultNames = result.map((final e) => e.name);
        expect(resultNames, containsAll(customers.map((final e) => e.name)));
      },
    );
    ...
    test(
      ...
      () async {
        ...
        final result = await Customer.db.find(
          session,
          where: (final c) => c.orders.count() > 0,
        );
    ...
    test(
      ...
      () async {
        ...
        final result = await Customer.db.find(
          session,
          where: (final c) => c.orders.count() < 2,
        );
    ...
    test(
      ...
      () async {
        ...
        final result = await Customer.db.find(
          session,
          where: (final c) => c.orders.count().between(0, 1),
        );
    ...
    test(
      ...
      () async {
        ...
        final result = await Customer.db.find(
          session,
          where: (final c) => c.orders.count().notBetween(0, 1),
        );
