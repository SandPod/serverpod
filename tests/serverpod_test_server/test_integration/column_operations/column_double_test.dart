  ...
  group('Given double column in database', () {
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.equals(1.0),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.equals(null),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.notEquals(1.0),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.notEquals(null),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.inSet({1.0, 2.0}),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.notInSet({1.0}),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.notInSet({}),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.between(1.0, 2.0),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDouble.notBetween(1.0, 2.0),
        );
