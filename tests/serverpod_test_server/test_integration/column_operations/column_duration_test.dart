...
const firstDuration = Duration(hours: 10);
const secondDuration = Duration(hours: 20);
const thirdDuration = Duration(hours: 30);
  ...
  group('Given duration column in database', () {
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.equals(firstDuration),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.equals(null),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.notEquals(firstDuration),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.notEquals(null),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.inSet({firstDuration, secondDuration}),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.inSet({}),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.notInSet({firstDuration}),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.notInSet({}),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration > firstDuration,
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration < thirdDuration,
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.between(firstDuration, secondDuration),
        );
    ...
    test(
      ...
      () async {
        final result = await Types.db.find(
          session,
          where: (final t) => t.aDuration.notBetween(firstDuration, secondDuration),
        );
