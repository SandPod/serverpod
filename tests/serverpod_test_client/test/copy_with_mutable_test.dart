  ...
  group('mutability', () {
    ...
    test(
      ...
      () {
        ...
        expect(types.aMap?.$1, isEmpty);
        expect(typesCopy.aMap?.$1, equals({1: 2}));
      },
    );
    ...
    group(
      ...
      () {
        var objectWithNestedObjects = ObjectWithObject(
          ...
          nestedDataMap: {
            'firstKey': {333: SimpleData(num: 333)},
          },
        );
        ...
        test('then a nested map is deeply cloned', () {
          ...
          expect(
            objectWithNestedObjects.nestedDataMap?['firstKey']?[333]?.num,
            equals(333),
          );
        ...
        test('then a nested list is deeply cloned', () {
          ...
          expect(
            objectWithNestedObjects.nestedDataList?.first[1].num,
            equals(99),
          );
        ...
        test('then a nested list in a map is deeply cloned', () {
          ...
          expect(
            copy.nestedDataListInMap?['firstKey']?.first?.first[111]?.num,
            equals(111),
          );

          expect(
            objectWithNestedObjects
                .nestedDataListInMap?['firstKey']?[1]
                ?.first[222]
                ?.num,
            equals(222),
          );
          expect(
            copy.nestedDataListInMap?['firstKey']?[1]?.first[222]?.num,
            equals(12345),
          );
        });
      },
