...
void main() {
  group('Given a ColumnDateTime expression', () {
    ...
    test(
        ...
        () {
      var comparisonExpression = expression.equals(DateTime(1991, 5, 28));

      expect(comparisonExpression.toString(),
          '"$columnName" = \'"1991-05-27T22:00:00.000Z"\'');
    });
    ...
    test(
        ...
        () {
      var comparisonExpression = expression.notEquals(DateTime(1991, 5, 28));
