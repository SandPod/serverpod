...
class EmailIDPAuthenticationUtils {
  final EmailIDPPasswordHashUtil _passwordHash;
  final RateLimit _failedLoginRateLimit;

  /// Creates a new instance of [EmailIDPAuthenticationUtils].
  EmailIDPAuthenticationUtils({
    required final EmailIDPPasswordHashUtil passwordHash,
  ...
  Future<UuidValue> authenticate(
    ...
    return DatabaseUtil.runInTransactionOrSavepoint(
      ...
      (final transaction) async {
        ...
        if (!await _passwordHash.validateHash(
          value: password,
